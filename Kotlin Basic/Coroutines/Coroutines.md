...
Có 1 phương án để giải quyết vấn đề trên là với mỗi tác vụ ngầm (background service), ta sẽ cho 1 Thread đảm nhiệm vai trò này và sau đó báo cáo lại kết quả cho UI Thread. Tuy nhiên, việc có nhiều Thread được tạo ra từ 1 ứng dụng cũng sẽ gây ra nhiều vấn đề và tiêu tốn khá nhiều tài nguyên.
...
```java
// Tạo coroutine tại gloaal (app) level
